...
<body>
	<%
		...
		String queryString = "select id_order from candi_info where id_number = '" + id_number
	...
	<div align="center">
		...
		<h1>
			地市：<%=area_name%></h1>
		<h1>
			<font color="red">您的准考证号为：<%=id_order%></font>
		</h1>
	</div>
	<%
		} else {
	...
	<div align="center">
		...
		<h1>
			地市：<%=area_name%></h1>
		<h1>
			<font color="red">您的准考证号为：<%=user_id_order%></font>
		</h1>
	</div>
	<%
		} else {
	...
	<div align="center">
		<h1>
			<font color="red">准考证号已分配完毕，请与工作人员联系，谢谢！</font>
		</h1>
	</div>
